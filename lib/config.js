...
const ADMIN_BOOTSTRAP_USERNAME = process.env.ADMIN_USERNAME || process.env.ADMIN_BOOTSTRAP_USERNAME || 'admin';
const ADMIN_BOOTSTRAP_PASSWORD = process.env.ADMIN_PASSWORD || process.env.ADMIN_BOOTSTRAP_PASSWORD || '';
const ADMIN_BOOTSTRAP_EMAIL = process.env.ADMIN_EMAIL || process.env.ADMIN_BOOTSTRAP_EMAIL || '';
