const DEFAULT_CONTENT = {
  ...
  sectionsOrder: ['hero', 'services', 'team', 'testimonials', 'news', 'updates', 'articles', 'about', 'certificates', 'contact', 'cta'],
  sectionVisibility: { hero: true, services: true, team: true, testimonials: true, news: true, updates: true, articles: true, about: true, certificates: true, contact: true, cta: true },
  services: [
