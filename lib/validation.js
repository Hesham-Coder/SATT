...
function extractPhoneString(value) {
  // Handle bilingual objects {en: '...', ar: '...'} that may have been stored
  // by older versions of the editor before phone fields became non-bilingual.
...
function validatePhoneSetting(value, label) {
  // Strip bidi / invisible Unicode control characters that the RTL helper may inject
